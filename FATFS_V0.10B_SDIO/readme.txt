1. the example is FATFS_V0.10B_SDIO use for SOM-STM32F429IG.
...
2. instructions for use:
   ...
   (5) Connect Micro-USB cable with computer to SOM-STM32F429IG (USB TO USART1), install the CP2102 driver (in tools files),
       ...
       no flow control.
   (6) Insert SD card on the Board.
   (7) Run example and open the terminal, the terminal will display information.