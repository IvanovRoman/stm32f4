...
#define FATFS_USE_WRITEPROTECT_PIN_RCC		RCC_AHB1Periph_GPIOD			
#define FATFS_USE_WRITEPROTECT_PIN_PORT		GPIOD
#define FATFS_USE_WRITEPROTECT_PIN_PIN		GPIO_Pin_3
#endif
#endif
